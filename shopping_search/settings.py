...
DATABASES = {
    'default': {
        ...
        'NAME': 'sample.sqlite3',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '^_)#a&u*f0oyy95t+==epfev_e0m09eg_nya%jnpf6yk!u66*e'
...
ROOT_URLCONF = 'shopping_search.urls'
